...
public class RestApiCategories extends TestCase {
    ...
    String methodName;
	@Test
	public void testRestApiCategories() throws InterruptedException, IOException, Exception {
		try{
	...
	public void setUp() throws Exception {
        ...
        contextName = phrsc.CONTEXT_ESHOP+phrsc.CONTEXT_REST_API+phrsc.CONTEXT_CATEGORIES;
	}
